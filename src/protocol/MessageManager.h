...
#include "networking/session/ClientSession.h"

#include "../shared/utils/debug/Debugger.h"
#include "../shared/base/PiranhaMessage.h"
#include "../shared/utils/PassToken.h"
...
public:
    MessageManager(ClientSession* session) {
        _session = session;
...
private:
    void OnClientHelloMessage(ClientHelloMessage* message) {
        ...
        _session->SendMessage(new ServerHelloMessage());
    }
    ...
    void OnHomeReadGenericStorageReqMessage(HomeReadGenericStorageReqMessage* genericStorageRequest) {
        ...
        _session->SendMessage(new HomeReadGenericStorageRspMessage());
    }
    ...
    void OnLeaderboardGetCurrentRankReqMessage(LeaderboardGetCurrentRankReqMessage* getRankRequest) {
        ...
        _session->SendMessage(new LeaderboardGetCurrentRankRspMessage());
    }
    ...
    void OnSeasonShopFullInfoReqMessage(SeasonShopFullInfoReqMessage* shopRequest) {
        ...
        _session->SendMessage(new SeasonShopFullInfoRspMessage());
    }
